...
public class Payment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView monthlyPayment = (TextView) findViewById(R.id.tvMonthlyPayment);
        ImageView image = (ImageView)  findViewById(R.id.ivYears);
        ...
        decMonthlyPayment = ( (intLoan + (intLoan * decInterest * intYears) ) / (12 * intYears) );
